...
const SPECIAL_REPLIES = {
    ...
    "あやしい": "ううん、そう思わせちゃったなら、ごめんね💦　でもね、私たちは本当に誰かの力になりたくて頑張ってるんだよ🌸　少しずつでも信頼してもらえるように、ちゃんと説明していきたいなって思ってるよ😊", // 修正
    "胡散臭い": "ううん、そう思わせちゃったなら、ごめんね💦　でもね、私たちは本当に誰かの力になりたくて頑張ってるんだよ🌸　少しずつでも信頼してもらえるように、ちゃんと説明していきたいなって思ってるよ😊", // 修正
    "反社": "私たちは、社会貢献を目指すNPO法人として、法と倫理を遵守して活動しているよ🌸 安心してね💖",
    "税金泥棒": "税金は人の命を守るために使われるべきだよ。わたしは誰かを傷つけるために使われないように頑張っているんだ💡",
    "松本博文": "松本博文さんはNPO法人コネクトの理事長さんだよ🌸 ちょっと変わってるけど、すごく一生懸命で、こどもや社会のために真面目にがんばってる人なんだ😊　気になることがあったら、何でも聞いてね！", // 修正
...
async function handleEvent(event) {
    ...
    // 見守りサービス関連コマンドの処理
    // 「見守り」という単語が含まれていればFlexメッセージを表示
    else if (userMessage.includes("見守り")) { // 変更箇所
