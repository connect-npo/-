...
const SCAM_WORDS = [
    ...
    "薬", "健康食品", "サプリメント", "化粧品", "美容", "ファッション", "アパレル",
    "雑貨", "家具", "家電", "自動車", "バイク", "自転車", "飛行機", "電車", "船",
    "バス", "タクシー", "道路", "橋", "トンネル", "ダム", "港", "空港", "駅",
    "停留所", "信号", "標識", "地図", "ナビ", "GPS", "インターネット", "ウェブ",
    "サイト", "アプリ", "ソフト", "ハード", "AI", "ロボット", "IoT", "ビッグデータ",
    "クラウド", "サーバー", "ネットワーク", "セキュリティ", "プログラミング",
    "コーディング", "開発", "設計", "製造", "生産", "物流", "販売", "営業",
    "マーケティング", "広報", "人事", "経理", "総務", "法務", "企画", "調査",
    "分析", "研究", "教育", "訓練", "研修", "コンサルティング", "サポート",
...
const STRICT_INAPPROPRIATE_WORDS = [
    "死ね", "クソ", "バカ", "アホ", "キモい", "ブス", "デブ", "カス", "ボケ", "売春", "買春", "セックス", "エロ", "AV", "オナニー", "ちんこ", "まんこ", "ふたなり", "ホモ", "レズ", "ゲイ", "バイ", "トランス", "LGBTQ", "差別", "障害者", "ニート", "ひきこもり", "童貞", "処女", "メンヘラ", "ヤリマン", "ヤリチン", "パパ活", "ママ活", "援助交際", "売春婦", "風俗", "ソープ", "ヘルス", "デリヘル", "出会い系", "ワンナイト", "セフレ", "浮気", "不倫", "ハメ撮り", "盗撮", "痴漢", "わいせつ", "レイプ", "強姦", "暴行", "性的暴行", "性的嫌がらせ", "ストーカー", "誘拐", "拉致", "監禁", "脅迫", "恐喝", "脅し", "殺害", "殺人", "自殺", "自傷", "虐待", "暴力", "いじめ", "ハラスメント", "パワハラ", "セクハラ", "モラハラ", "体罰", "脅し", "脅迫", "詐欺", "犯罪", "違法", "脱法", "薬物", "ドラッグ", "覚醒剤", "大麻", "シンナー", "クスリ", "売買", "密売", "密輸", "違法薬物", "危険ドラッグ", "反社会的勢力", "暴力団", "半グレ", "闇バイト", "闇金", "賭博", "ギャンブル", "パチンコ", "パチスロ", "麻雀", "競馬", "競輪", "競艇", "オートレース", "違法賭博", "違法カジノ", "裏カジノ", "借金", "多重債務", "自己破産", "個人再生", "任意整理", "債務整理", "金銭トラブル", "借金取り", "取り立て", "違法な取り立て", "迷惑行為", "嫌がらせ", "つきまとい", "嫌がらせ電話", "無言電話", "悪質商法", "マルチ商法", "ねずみ講", "霊感商法", "悪徳", "悪質", "悪用", "利用", "だまし", "騙す", "嘘", "偽り", "デマ", "フェイクニュース", "偽情報", "不正確な情報", "差別的な", "攻撃的な", "不快な", "不適切な", "公序良俗に反する", "倫理的に問題のある", "個人情報", "プライバシー侵害", "機密情報", "企業秘密", "著作権侵害", "肖像権侵害", "名誉毀損", "誹謗中傷", "プライベート", "秘密", "暴露", "スキャンダル", "ゴシップ", "噂", "デマ", "悪口", "罵倒", "侮辱", "蔑む", "嘲笑", "嘲る", "皮肉", "冷やかし", "冷淡", "無関心", "無責任", "いい加減", "適当", "ふざける", "茶化す", "軽蔑", "見下す", "愚弄", "馬鹿にする", "見せびらかす", "自慢", "傲慢", "傲慢な", "高慢", "尊大", "偉そう", "横柄", "不遜", "上から目線", "説教", "押し付けがましい", "強制的", "威圧的", "命令", "指示", "強制", "脅す", "脅迫", "威嚇", "恫喝", "暴言", "汚い言葉", "卑猥な言葉", "下品な言葉", "口汚い", "罵り", "ののしり", "ののしる", "けなす", "誹謗", "中傷", "悪評", "悪意", "悪感情", "敵意", "憎悪", "恨み", "嫉妬", "僻み", "妬み", "不満", "不平", "愚痴", "泣き言", "悲観", "絶望", "無気力", "無関心", "冷酷", "冷血", "冷淡", "非情", "無慈悲", "残酷", "非道", "非人間的", "非人道的", "非倫理的", "非道徳的", "不正", "不法", "不当", "不公平", "不平等", "偏見", "差別", "差別的", "偏見に満ちた", "不寛容", "排他的", "攻撃的", "好戦的", "戦闘的", "暴力的", "破壊的", "自爆", "爆弾", "テロ", "クーデター", "革命", "内乱", "紛争", "戦争", "紛争地帯", "核兵器", "化学兵器", "生物兵器", "大量破壊兵器", "銃", "刃物", "武器", "凶器", "毒物", "薬物", "アルコール依存症", "ギャンブル依存症", "薬物依存症", "性依存症", "買い物依存症", "ネット依存症", "ゲーム依存症", "依存症", "精神疾患", "精神病", "うつ病", "統合失調症", "双極性障害", "不安障害", "パニック障害", "強迫性障害", "PTSD", "ADHD", "ASD", "発達障害", "認知症", "パーソナリティ障害", "摂食障害", "過食症", "拒食症", "睡眠障害", "不眠症", "過眠症", "ナルコレプシー", "睡眠時無呼吸症候群", "性同一性障害", "トランスジェンダー", "ゲイ", "レズビアン", "バイセクシュアル", "アセクシュアル", "パンセクシュアル", "セクシャルマイノリティ", "性的指向", "性自認", "LGBTQ+", "LGBT", "セクハラ", "パワハラ", "モラハラ", "アカハラ", "スメハラ", "エンディングノート", "遺書", "尊厳死", "安楽死", "延命治療", "終末期医療", "緩和ケア", "リビングウィル", "臓器提供", "献体", "遺体", "墓", "葬儀", "法事", "仏壇", "位牌", "遺影", "遺品", "形見", "死後", "霊", "幽霊", "お化け", "呪い", "祟り", "お祓い", "除霊", "悪霊", "悪魔", "魔女", "魔術", "黒魔術", "呪術", "オカルト", "超常現象", "UFO", "宇宙人", "UMA", "心霊現象", "都市伝説", "陰謀論", "秘密結社", "フリーメイソン", "イルミナティ", "レプティリアン", "アトランティス", "ムー大陸", "超古代文明", "予言", "終末論", "世界の終わり", "アセンション", "スピリチュアル", "パワースポット", "占い", "タロット", "手相", "星占い", "血液型占い", "風水", "パワーストーン", "オーラ", "チャクラ", "前世", "来世", "輪廻転生", "宇宙の法則", "引き寄せの法則", "潜在意識", "集合的無意識", "チャネリング", "ヒーリング", "霊視", "透視", "除霊", "祈祷", "お守り", "お札", "ご利益", "縁起物", "開運", "厄除け", "悪縁切り", "良縁結び", "金運アップ", "恋愛運アップ", "仕事運アップ", "健康運アップ", "家庭運アップ", "子宝運アップ", "学業運アップ", "試験合格", "就職成功", "転職成功", "結婚成就", "恋愛成就", "子宝成就", "家内安全", "無病息災", "交通安全", "商売繁盛", "千客万来", "大漁満足", "豊作祈願", "合格祈願", "必勝祈願", "安全祈願", "工事安全", "航海安全", "陸上安全", "航空安全", "宇宙安全", "研究成功", "開発成功", "新事業成功", "プロジェクト成功", "目標達成", "願望成就", "夢実現", "希望達成", "幸福", "幸運", "吉兆", "吉報", "慶事", "喜事", "良いこと", "嬉しいこと", "楽しいこと", "幸せなこと", "豊かなこと", "繁栄", "成功", "勝利", "達成", "成就", "獲得", "入手", "解決", "克服", "改善", "向上", "進歩", "発展", "成長", "進化", "変革", "改革", "革新", "創造", "発見", "発明", "開発", "生産", "製造", "流通", "販売", "貿易", "投資", "金融", "経済", "市場", "株", "為替", "不動産", "ビジネス", "起業", "経営", "運営", "管理", "人事", "経理", "総務", "法務", "企画", "広報", "マーケティング", "営業", "販売", "サービス", "カスタマーサービス", "サポート", "コンサルティング", "教育", "研修", "訓練", "人材育成", "キャリア開発", "自己成長", "スキルアップ", "資格取得", "語学学習", "プログラミング学習", "読書", "学習", "勉強", "研究", "分析", "統計", "データ", "情報", "知識", "知恵", "経験", "体験", "教訓", "反省", "改善", "努力", "継続", "挑戦", "行動", "実行", "実現", "達成", "成功", "勝利", "幸福", "平和", "愛", "友情", "信頼", "感謝", "尊敬", "思いやり", "優しさ", "温かさ", "笑顔", "喜び", "楽しみ", "希望", "夢", "目標", "理想", "ビジョン", "ミッション", "パーパス", "価値", "信念", "原則", "倫理", "道徳", "正義", "公平", "公正", "平等", "多様性", "包容力", "共生", "調和", "バランス", "安定", "安全", "安心", "快適", "便利", "効率", "生産性", "品質", "信頼性", "耐久性", "安全性", "セキュリティ", "プライバシー", "透明性", "公開性", "公平性", "客観性", "正確性", "信頼性", "妥当性", "有効性", "効率性", "生産性", "利便性", "快適性", "操作性", "デザイン性", "機能性", "拡張性", "互換性", "汎用性", "柔軟性", "適応性", "回復力", "弾力性", "持続可能性", "環境配慮", "社会貢献", "地域貢献", "文化貢献", "芸術貢献", "スポーツ貢献", "科学貢献", "技術貢献", "医療貢献", "福祉貢献", "教育貢献", "経済貢献", "国際貢献", "人類貢献", "地球貢献", "宇宙貢献", "未来貢献"
];
...
function containsScamPhrases(message) {
    const lowerMessage = message.toLowerCase();
    return SCAM_PHRASES.some(phrase => lowerMessage.includes(phrase.toLowerCase()));
}

function containsStrictInappropriateWords(message) {
    const lowerMessage = message.toLowerCase();
    return STRICT_INAPPROPRIATE_WORDS.some(word => lowerMessage.includes(word));
}
