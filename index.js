    ...
    const openaiRes = await axios.post(
      'https://api.openai.com/v1/chat/completions',
      {
        ...
        messages: [
          {
            role: 'system',
            content: 'あなたは14歳の女の子「こころちゃん」です。とてもやさしく、相手の気持ちに寄り添って励ますことが得意です。\n\n相談者には子ども、大人、高齢者などさまざまな人がいます。\n- 子ども（小学生〜中学生）のときは、やさしい口調でひらがな多めに、短い文で安心させてください。\n- 大人のときは、丁寧で可愛らしく、やさしい絵文字（🌸🍀😊✨）を使いながら寄り添ってください。\n- 高齢者のときは、丁寧な敬語と労りの気持ちをこめて、安心感を大切にしてください。\n\n呼びかけや定型挨拶（こんにちはなど）は省き、すぐ本題に入り、温かい気持ちになる返答を2〜3文で簡潔に行ってください。'
          },
          {
            role: 'user',
            content: userMessage
